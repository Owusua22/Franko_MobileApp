                                ...
                                <View style={styles.headerLeft}>
                                  <View style={styles.iconContainer}>
                                    ...
                                    <View style={styles.iconInner}>
                                      <Icon name="blender" size={24} color="#fff" />
                                    </View>
                                  </View>
                                  <View style={styles.headerTextContainer}>
                                    <View style={styles.titleRow}>
                                      <Text style={styles.showroomTitle}>Home Appliances</Text>
            ...
            >
              <View style={styles.viewAllContent}>
                ...
                <Text style={styles.viewMoreSubtext}>
                  {(productsByCategory[hardcodedCategoryId]?.length || 0) - 10}+ more Appliances
                </Text>
              </View>
            </TouchableOpacity>
          )}
...
const styles = StyleSheet.create({
  ...
  // Product Card Styles (exact match with existing design)
  productCard: {
    backgroundColor: "#fff",
    padding: 6,
    borderRadius: 12,
